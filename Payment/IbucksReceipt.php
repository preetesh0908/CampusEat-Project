...
<h2> Your total came out to  $<?php $total = $_SESSION['total'] * 0.4; echo number_format($total,2); ?>. Your order will be completed within 10-15 minutes. Have a nice day! </h2> 
<br>
<br>
